...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-dashboard-dashboard-module~pages-login-login-module~pages-registration-registration-mo~f56288c2"], {
  /***/
  ...
  function srcAppServicesAuthenticationServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AuthenticationService = /*#__PURE__*/function () {
      ...
      _createClass(AuthenticationService, [{
        key: "signIn",
        value: function signIn(email, phrase) {
          return this.ngFireAuth.signInWithEmailAndPassword(email, phrase);
        }
      }, {
        key: "registerUser",
        value: function registerUser(email, phrase) {
          return this.ngFireAuth.createUserWithEmailAndPassword(email, phrase);
        }
      }, {
        ...
        value: function sendVerificationMail() {
          ...
          this.ngFireAuth.currentUser.then(function (user) {
        ...
        key: "phraseRecover",
        value: function phraseRecover(phraseResetEmail) {
          return this.ngFireAuth.sendPasswordResetEmail(phraseResetEmail).then(function () {
            window.alert('已寄出重設密碼信件，請至信箱收取');
        ...
        value: function setUserData(user) {
          var userRef = this.afStore.doc("users/".concat(user.uuid));
          var userData = {
            uuid: user.uuid,
            email: user.email,
        ...
        get: function get() {
          var user = JSON.parse(localStorage.getItem('user'));
          return user.emailVerified === false ? false : true;
        }
      }]);
...
//# sourceMappingURL=default~pages-dashboard-dashboard-module~pages-login-login-module~pages-registration-registration-mo~f56288c2-es5.js.map